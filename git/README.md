...
* Whenever a project is build and released, mark it as a release version on GitHub.
  This can be done in the repository under 'releases'.
  ([how-to](https://help.github.com/articles/creating-releases/))
